...
class MCAPI {
    ...
    */
     ...
     *
     * @param string $id the list id to connect to. Get by calling lists()
     * @param string $status the status to get members for - one of(subscribed, unsubscribed, <a target="_blank" href="https://eepurl.com/dwk1">cleaned</a>, updated), defaults to subscribed
